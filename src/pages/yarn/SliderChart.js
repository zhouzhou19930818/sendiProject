...
import 'src/assets/css/echarts.scss';
...
export default class SliderChart extends React.Component {
    ...
    componentWillReceiveProps(nextProps, nextContext) {
        this.chart.setOption(nextProps.options || options);
    }
    ...
    setMarkArea = () => {
        ...
        this.chart.setOption(update(this.props.options || options, {
            series: {
                0: {
                    markArea: {
                        data: {
                            $set: [
                                [{
                                    x: leftPercent * 100 + '%', // index
                                }, {
                                    x: rightPercent * 100 + '%', // index
                                },]
                            ]
                        }
                    }
     ...
     */
    setSlider = (start, end) => {
        this.slideBlock.style.left = start + '%';
        this.slideBlock.style.right = (100 - end) + "%";
        this.setMarkArea();
    };
